...
@app.get("/players/me", response_model=schemas.Speler)
...
@app.post("/players/", response_model=schemas.Speler)
...
@app.put("/players/{speler_id}", response_model=schemas.Speler)
...
@app.post("/players/{speler_id}/single/", response_model=schemas.Enkelspel)
...
@app.get("/single/", response_model=list[schemas.Enkelspel])
...
@app.post("/players/{speler_id}/dubble/", response_model=schemas.Dubbelspel)
...
@app.get("/dubble/", response_model=list[schemas.Dubbelspel])
